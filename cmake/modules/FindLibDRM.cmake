...
# LIBDRM_DEFINITIONS  - the GBM definitions
#
...
check_c_source_compiles("#include <drm_mode.h>
                         ...
                         " LIBDRM_HAS_HDR_OUTOUT_METADATA)

if(LIBDRM_FOUND)
  set(LIBDRM_LIBRARIES ${LIBDRM_LIBRARY})
  set(LIBDRM_INCLUDE_DIRS ${LIBDRM_INCLUDE_DIR})
  set(LIBDRM_DEFINITIONS -DHAVE_LIBDRM=1)
  if(LIBDRM_HAS_HDR_OUTOUT_METADATA)
    list(APPEND LIBDRM_DEFINITIONS -DHAVE_HDR_OUTOUT_METADATA=1)
  endif()
